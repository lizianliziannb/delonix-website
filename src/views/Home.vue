...
const brandImages = [
  {
    key: "kaiyuanmingdu",
    image:
      "https://rc2.zihu.com/g4/M00/69/48/CgAG0mNJUZ-AeorYAAUwizbionQ758.jpg",
  },
  {
    key: "kaiyuanmingting",
    image:
      "https://rc2.zihu.com/g5/M00/49/EE/CgAGbGlChmuAfUWcAAXR7R8iZU0044.jpg",
  },
  {
    key: "manju",
    image:
      "https://rc2.zihu.com/g5/M00/42/CC/CgAGbGi6emSAAo9tABHxkDsccbM239.jpg",
  },
  {
    key: "monday",
    image:
      "https://rc2.zihu.com/g5/M00/2D/5C/CgAGbGc6p1OAa8ODAANTa7NhjFo771.jpg",
  },
  {
    key: "fangwai",
    image:
      "https://rc2.zihu.com/g4/M00/69/48/CgAG0mNJUBOAFA1eAARujHbcwiY174.jpg",
  },
  {
    key: "guantang",
    image:
      "https://rc2.zihu.com/g4/M00/69/48/CgAG0mNJUAeACpm_AARHJK8FneA943.jpg",
  },
  {
    key: "fangcaodi",
    image:
      "https://rc2.zihu.com/g4/M00/69/48/CgAG0mNJUKmAJojMAAV-F3Rfm_4153.jpg",
  },
];
...
const newsKeys = [
  {
    titleZh: "AI重构生态 客户驱动增长 德胧集团召开2026战略发布会",
    titleEn: "AI Reshaping Ecosystem - Delonix Group 2026 Strategy Conference",
    titleId:
      "AI Membangun Ulang Ekosistem - Konferensi Strategi Delonix Group 2026",
  },
  {
    titleZh: "德胧集团旗下核心品牌焕新 开启全新叙事",
    titleEn: "Delonix Group Core Brands Refreshed with New Narrative",
    titleId: "Merek Inti Delonix Group Diperbarui dengan Narasi Baru",
  },
  {
    titleZh: "德胧集团深化东南亚战略布局",
    titleEn: "Delonix Group Deepens Southeast Asia Strategic Layout",
    titleId: "Delonix Group Memperdalam Tata Letak Strategis Asia Tenggara",
  },
  {
    titleZh: "德胧集团揽获海内外6项荣誉！",
    titleEn: "Delonix Group Wins 6 Awards at Home and Abroad!",
    titleId: "Delonix Group Meraih 6 Penghargaan!",
  },
  {
    titleZh: "德胧集团与万豪国际集团宣布达成8个合作项目签约",
    titleEn:
      "Delonix Group and Marriott International Announce 8 Project Signings",
    titleId: "Delonix Group dan Marriott International Tandatangani 8 Proyek",
  },
  {
    titleZh: "共话印尼新商机！全国首个印尼酒店投资者峰会举行",
    titleEn: "Indonesia Hotel Investor Summit Held in Hangzhou",
    titleId: "KTT Investor Hotel Indonesia Pertama Diadakan di Hangzhou",
  },
];
    ...
    <section class="hero-banner">
      ...
      >
        ...
        <transition name="text-fade" mode="out-in">
          <h1 class="banner-title" :key="'title-' + currentSlide">
            {{
              currentSlide === 0 ? t.banner.slide1.title : t.banner.slide2.title
            }}
          </h1>
        </transition>
        <div class="banner-line"></div>
        <transition name="text-fade" mode="out-in">
          <p class="banner-subtitle" :key="'sub-' + currentSlide">
            {{
              currentSlide === 0
                ? t.banner.slide1.subtitle
                : t.banner.slide2.subtitle
            }}
          </p>
        </transition>
      </div>
      <div class="banner-dots">
        ...
        >
          <span
            class="dot-progress"
            :class="{ running: currentSlide === index }"
          ></span>
        </span>
      </div>
        ...
        <div class="about-grid">
          ...
          <div class="about-image reveal" style="transition-delay: 0.2s">
            <div class="image-frame">
              <img
                src="https://rc2.zihu.com/g4/M00/69/51/CgAG0mNLb4KAD8slAATYxn00GhA160.png"
    ...
    <section class="brands-section">
      <div class="container">
        ...
        <div class="brands-grid">
          <div
            v-for="(brand, idx) in brandImages"
            :key="brand.key"
          ...
          >
            <div class="brand-image">
              <img
                :src="brand.image"
                :alt="(t.brandItems as any)[brand.key]?.name"
              />
            ...
            <h3 class="brand-name">
              {{ (t.brandItems as any)[brand.key]?.name }}
            </h3>
          </div>
        </div>
      </div>
      ...
      <div class="container cta-container">
        <div class="cta-content reveal">
          ...
          <div class="cta-actions">
            <a href="tel:1010-5050" class="cta-btn primary">{{
              t.cta.consult
            }}</a>
            <router-link to="/cooperation" class="cta-btn secondary">{{
              t.cta.invest
            }}</router-link>
          </div>
        </div>
...
.banner-badge {
  ...
  letter-spacing: 7px;
  margin-bottom: 30px;
  animation: fadeSlideIn 1s 0.3s both;
}
.banner-title {
  font-size: 52px;
  font-weight: 200;
  ...
  letter-spacing: 14px;
  margin-bottom: 20px;
  text-shadow: 0 3px 40px rgba(0, 0, 0, 0.25);
}
.banner-line {
  width: 50px;
  height: 1px;
  ...
  margin: 0 auto 20px;
  animation: fadeSlideIn 1s 0.7s both;
}
.banner-subtitle {
  font-size: 16px;
...
.stats-bg {
  position: absolute;
  inset: -40px;
  background: url("https://rc2.zihu.com/g5/M00/1B/E7/CgAGbGZMZkeAJaN0AAW6nd9Dxqc939.jpg")
    center/cover;
  filter: blur(3px);
}
.stats-overlay {
...
.brand-card:hover .brand-hover-inner {
  transform: translateY(0);
}
.brand-hover h4 {
  font-size: 16px;
...
.cta-bg {
  position: absolute;
  inset: 0;
  background: linear-gradient(135deg, #c9a96e 0%, #a88840 50%, #8b6e2f 100%);
}
.cta-overlay {
  position: absolute;
  inset: 0;
  background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60"><path d="M0 0h60v60H0z" fill="none"/><circle cx="30" cy="30" r="0.5" fill="rgba(255,255,255,0.08)"/></svg>');
}
.cta-container {
  position: relative;
  z-index: 1;
